...
@Data
public class UpdateRepositoryDetectionRequest {
	private long id;
	...
	public UpdateRepositoryDetectionRequest() {
		
	}
	
	public UpdateRepositoryDetectionRequest(long id, String soirNo, long amountNo, String pieceNo, long prjectNo,
