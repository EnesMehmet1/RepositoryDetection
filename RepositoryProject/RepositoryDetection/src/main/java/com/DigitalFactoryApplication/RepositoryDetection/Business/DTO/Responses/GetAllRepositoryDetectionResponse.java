...
@AllArgsConstructor
@NoArgsConstructor
public class GetAllRepositoryDetectionResponse {
	private long id;
	...
	public GetAllRepositoryDetectionResponse() {
		
	}
	
	public GetAllRepositoryDetectionResponse(long id, String soirNo, long amountNo, String pieceNo, long prjectNo,
